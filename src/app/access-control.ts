import { StringAdapter, newModel } from 'casbin'
...
p, editor, companies, (show)|(list)|(create)|(edit)|(delete)
p, editor, companies/*, (show)|(list)|(create)|(delete)|(edit)

p, editor, contacts, list
